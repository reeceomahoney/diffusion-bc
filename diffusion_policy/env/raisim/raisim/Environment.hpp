...
namespace raisim {
    ...
    public:
        ...
        void getJointPositionErrorHistory(Eigen::Ref<EigenVec> jointPositionErrorHistory) {
            jointPositionErrorHistory = observationHandler_.getJointPositionErrorHistory().cast<float>();
        }

        void getJointVelocityHistory(Eigen::Ref<EigenVec> jointVelocityHistory) {
            jointVelocityHistory = observationHandler_.getJointVelocityHistory().cast<float>();
        }
        ...
        void getContactStates(Eigen::Ref<EigenVec> contactStates) {
            ...
            for (auto& contact: robot_->getContacts()) {
                if (contact.getlocalBodyIndex() == robot_->getBodyIdx("LF_SHANK")) {
                    contacts_[0] = 1.;
                } else if (contact.getlocalBodyIndex() == robot_->getBodyIdx("RF_SHANK")) {
                    contacts_[1] = 1.;
                } else if (contact.getlocalBodyIndex() == robot_->getBodyIdx("LH_SHANK")) {
                    contacts_[2] = 1.;
                } else if (contact.getlocalBodyIndex() == robot_->getBodyIdx("RH_SHANK")) {
                    contacts_[3] = 1.;
                }
            }
        }
